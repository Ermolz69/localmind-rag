...
For the current ER diagram and MVP table overview, see [MVP Architecture And Walking Skeleton](./mvp-architecture-and-walking-skeleton.md#local-database-er-diagram).
