...
namespace KnowledgeApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260620192559_AddCompanionDevices")]
    partial class AddCompanionDevices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KnowledgeApp.Domain.Entities.CompanionDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("companion_devices", (string)null);
                });
            ...
            modelBuilder.Entity("KnowledgeApp.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("TitleEditedAt")
                        .HasColumnType("TEXT");
